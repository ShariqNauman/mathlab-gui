...
#Initialization
sound_path = os.path.abspath("./assets/click.wav")
wallpaper_path = os.path.abspath("./assets/main.png")
sheet_path = os.path.abspath("./assets/sheet.xlsx")
ringtone_path = os.path.abspath("./assets/ringtone.mp3")
pygame.mixer.init()
